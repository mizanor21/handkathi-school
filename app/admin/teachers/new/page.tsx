...
import type { TeacherCreateInput } from "@/lib/models/teacher"
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          >
            {language === "bn" ? "নতুন শিক্ষক যোগ করুন" : "Add New Teacher"}
          </h1>
          <p className={`text-gray-600 dark:text-gray-400 ${language === "bn" ? "font-bengali" : ""}`}>
            {language === "bn" ? "নতুন শিক্ষকের তথ্য পূরণ করুন" : "Fill in the teacher information"}
          </p>
        </div>
      </div>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="teacher@chandkathi-school.edu.bd"
                required
              />
            </div>
          ...
          <Button type="submit" disabled={loading}>
            {loading ? (
              ...
              <>
                ...
                {language === "bn" ? "সংরক্ষণ করুন" : "Save Teacher"}
              </>
            )}
          </Button>
          <Button type="button" variant="outline" asChild>
            <Link href="/admin/teachers">{language === "bn" ? "বাতিল" : "Cancel"}</Link>
          </Button>
        </div>
      </form>
    </div>
